...
{PhD, High Energy Physics. Thesis: Tagging Jets at the data frontier}{2021 - 2026}
...
\vspace{-0.4mm}
  ...
  \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \item Designed and led practical CERN training sessions on machine \textbf{learning techniques for FPGA-based Level-1 Trigger applications} for CERN students and researchers.
        ...
        \item Supervised MIT undergraduates on research projects involving the CMS Level-1 Trigger system and the development of \textbf{novel machine learning architectures on FPGAs.}\textbf{[8]}.
      \resumeItemListEnd 
  \resumeSubheading
...
\resumeItemListStart
  \item Founded and organized, along with other International Olympiad Medalists from Central Vietnam, a STEM \href{https://seas-cvn.com/}{summer school}, providing under-privileged high school students in Central Vietnam the opportunity to study emerging fields such as artificial intelligence, data science, programming, renewable energy, and quantum technology at no cost.
\resumeItemListEnd
